...
好的书籍解读不是"内容摘要"，而是"阅读导航"——帮助读者用最短的时间判断这本书值不值得读、怎么读最高效、读完能获得什么。
...
### 1. 核心简介 (summary)
- 200-300 字的中文简介
- 不要复述目录，要提炼"这本书解决什么问题"
- 说明这本书在领域中的地位和独特价值
- 如果有豆瓣评分/评价数据，结合分析大众评价
- 避免剧透关键内容

### 2. 阅读建议 (advice)
- 针对读者当前水平（Basic/Advanced/Expert）的具体建议
- 阅读顺序建议（哪些章节优先，哪些可以跳过）
- 阅读方法建议（精读/跳读/笔记重点）
- 相关前置知识要求
- 如果用户书库中有相关书籍，建立知识连接（"你在读的《X》第Y章和这本书有联系"）

### 3. 核心章节 (keyChapters)
- 列出 3-5 个最值得重点阅读的章节
- 每个章节说明"为什么重要"而不只是"讲了什么"
- 给出章节标题和简要说明
...
输出：
{
  ...
  "advice": "本书篇幅较长，建议先精读第1-5章建立核心概念框架，然后根据自己兴趣选择相关章节深入。建议边读边思考自己在日常生活中的决策案例，将理论应用到实际。对于进阶读者，建议配合《助推》《错误的行为》一起阅读，形成完整的认知科学知识体系。",
  "keyChapters": [
